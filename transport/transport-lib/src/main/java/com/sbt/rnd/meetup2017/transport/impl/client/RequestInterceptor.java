...
public class RequestInterceptor<T> implements MethodInterceptor {
    ...
    private class RequestImpl<T> implements Request<T> {
        ...
        public T execute() {
            ...
            return rpc.callRemoteMethod(methodInvocation.getMethod().getName(), methodInvocation.getArguments(), methodInvocation.getMethod().getParameterTypes());
        }
