...
public class SpringApiServer implements ApiServer, ApplicationContextAware, InitializingBean, DisposableBean {
    private static final Logger logger = LoggerFactory.getLogger(SpringApiServer.class);
    ...
    public SpringApiServer(TransportObjectFactory objectFactory, String baseApiPackage, String baseServicesPackage) {
        this.autoStart = true;
    ...
    private List<ApiServiceBean> getApiServices(String baseApiPackage, String baseServicesPackage) {
        ...
        do {
            ...
            while (true) {
                ...
                do {
                    ...
                    } while (!apiBeanClass.isAnnotationPresent(ApiImpl.class));
        ...
        throw new ApplicationContextException("No implementation marked @ApiImpl founded in context for @Api interface: " + apiClass.getName());
    }
